...
import { System, Command, CommandOptions, ParserOptions, ModerationWarnings } from '../typings'
...
export default new class Test implements System {
  ...
  private removeFromWarned({ type, username }: { type: keyof ModerationWarnings, username: string }) {
