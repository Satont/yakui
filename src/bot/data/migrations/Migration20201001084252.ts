...
export class Migration20201001084252 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "commands" ("id" serial primary key, "name" varchar(255) not null, "aliases" json null, "cooldown" int4 null, "description" text null, "response" text not null, "enabled" bool not null, "visible" bool not null, "permission" int2 not null, "price" int4 null, "usage" int4 null, "sound" int4 null);')
    ...
    this.addSql('alter table "commands" add constraint "commands_sound_foreign" foreign key ("sound") references "commands_sound" ("id") on update cascade on delete set null;')

    this.addSql('alter table "commands_sound" add constraint "commands_sound_commandid_foreign" foreign key ("commandId") references "commands" ("id") on update cascade;')
    this.addSql('alter table "commands_sound" add constraint "commands_sound_soundid_foreign" foreign key ("soundId") references "files" ("id") on update cascade;')
