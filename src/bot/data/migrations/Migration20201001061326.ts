...
export class Migration20201001061326 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "users" ("id" serial primary key, "username" varchar(255) null, "messages" int4 null, "watched" int8 null default \'0\', "points" int4 null, "lastMessagePoints" int8 null default \'1\', "lastWatchedPoints" int8 null default \'1\', "daily_messages_id" int4 null);');
    this.addSql('create index "users_username_index" on "users" ("username");');
    this.addSql('alter table "users" add constraint "users_daily_messages_id_unique" unique ("daily_messages_id");');
    ...
    this.addSql('create table "users_daily_messages" ("id" serial primary key, "userId" int4 null, "count" int4 null, "date" int8 not null, "user_id" int4 not null);');
    ...
    this.addSql('create table "songs_likes" ("id" serial primary key, "user_id" int4 not null, "userId" int4 null, "name" varchar(255) not null, "createdAt" int8 not null, "updatedAt" int8 null);');
    ...
    this.addSql('create table "commands" ("id" serial primary key, "name" varchar(255) not null, "aliases" json null, "cooldown" int4 null, "description" text null, "response" text not null, "enabled" bool not null, "visible" bool not null, "permission" int2 not null, "price" int4 null, "usage" int4 null, "sound_id" int4 null);');
    this.addSql('alter table "commands" add constraint "commands_name_unique" unique ("name");');
    this.addSql('alter table "commands" add constraint "commands_sound_id_unique" unique ("sound_id");');

    this.addSql('create table "commands_sound" ("id" serial primary key, "volume" int4 null, "commandId" int4 null, "soundId" int4 null);');

    this.addSql('alter table "users" add constraint "users_daily_messages_id_foreign" foreign key ("daily_messages_id") references "users_daily_messages" ("id") on update cascade on delete set null;');
    ...
    this.addSql('alter table "users_daily_messages" add constraint "users_daily_messages_userid_foreign" foreign key ("userId") references "users" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "users_daily_messages" add constraint "users_daily_messages_user_id_foreign" foreign key ("user_id") references "users" ("id") on update cascade;');
    ...
    this.addSql('alter table "songs_likes" add constraint "songs_likes_userid_foreign" foreign key ("userId") references "users" ("id") on update cascade on delete cascade;');

    this.addSql('alter table "commands" add constraint "commands_sound_id_foreign" foreign key ("sound_id") references "commands_sound" ("id") on update cascade on delete set null;');

    this.addSql('alter table "commands_sound" add constraint "commands_sound_commandid_foreign" foreign key ("commandId") references "commands" ("id") on update cascade on delete cascade;');
    this.addSql('alter table "commands_sound" add constraint "commands_sound_soundid_foreign" foreign key ("soundId") references "files" ("id") on update cascade on delete cascade;');

    this.addSql('alter table "songs_likes" add constraint "songs_likes_userid_name_unique" unique ("user_id", "name");');
