<template>
  <div>
    <b-form v-on:submit.prevent="onSubmit">
      ...
      <b-form-group>
        <template slot="label" label-for="message"> Greeting message <variables-list></variables-list> </template>
      ...
      <b-button class="btn-block" variant="success" v-if="greeting.enabled" v-on:click="greeting.enabled = !greeting.enabled"
        >Enabled</b-button
      >
      <b-button class="btn-block" variant="warning" v-if="!greeting.enabled" v-on:click="greeting.enabled = !greeting.enabled"
        >Disabled</b-button
      >
