<template>
  <div>
    <b-form v-on:submit.prevent="onSubmit">
      ...
      <b-form-group>
        <template slot="label" label-for="response"> Response <variables-list></variables-list> </template>
      ...
      <b-button class="btn-block" variant="success" v-if="keyword.enabled" v-on:click="keyword.enabled = !keyword.enabled"
        >Enabled</b-button
      >
      <b-button class="btn-block" variant="warning" v-if="!keyword.enabled" v-on:click="keyword.enabled = !keyword.enabled"
        >Disabled</b-button
      >
