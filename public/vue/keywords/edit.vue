<template>
  <div>
    ...
    <br>
    <button type="button" class="btn btn-block btn-success" @click="create">{{ translate('ui.edit') }}</button>
    <button type="button" class="btn btn-block btn-danger" @click="del()">{{ translate('ui.delete') }}</button>
    <br>
    <variables></variables>
  </div>
</template>
