...
class Moderation {
  ...
  async moderate (message, userstate) {
    if (userstate.badges.moderator || typeof userstate.badges.broadcaster !== 'undefined') return false
  ...
  async links (message, userstate) {
    ...
    if ((typeof userstate.badges.subscriber !== 'undefined' && !links.settings.moderateSubscribers) || !links.enabled) return false
  ...
  async symbols (message, userstate) {
    ...
    if ((typeof userstate.badges.subscriber !== 'undefined' && !symbols.settings.moderateSubscribers) || !symbols.enabled) return false
  ...
  async longMessage (message, userstate) {
    ...
    if ((typeof userstate.badges.subscriber !== 'undefined' && !longMessage.settings.moderateSubscribers) || !longMessage.enabled) return false
  ...
  async caps (message, userstate) {
    ...
    if ((typeof userstate.badges.subscriber !== 'undefined' && !caps.settings.moderateSubscribers) || !caps.enabled) return false
  ...
  async color (message, userstate) {
    ...
    if ((typeof userstate.badges.subscriber !== 'undefined' && !color.settings.moderateSubscribers) || !color.enabled) return false
  ...
  async emotes (message, userstate) {
    ...
    if ((typeof userstate.badges.subscriber !== 'undefined' && !emotes.settings.moderateSubscribers) || !emotes.enabled) return false
