...
class Moderation {
  ...
  links (userstate, message) {
    ...
    if ((userstate.badges && userstate.badges.vip !== undefined) && !links.settings.moderateVips) return false
  ...
  symbols (userstate, message) {
    ...
    if ((userstate.badges && userstate.badges.vip !== undefined) && !symbols.settings.moderateVips) return false
  ...
  longMessage (userstate, message) {
    ...
    if ((userstate.badges && userstate.badges.vip !== undefined) && !longMessage.settings.moderateVips) return false
  ...
  caps (userstate, message) {
    ...
    if ((userstate.badges && userstate.badges.vip !== undefined) && !caps.settings.moderateVips) return false
  ...
  color (userstate, message) {
    ...
    if ((userstate.badges && userstate.badges.vip !== undefined) && !color.settings.moderateVips) return false
  ...
  emotes (userstate, message) {
    ...
    if ((userstate.badges && userstate.badges.vip !== undefined) && !emotes.settings.moderateVips) return false
